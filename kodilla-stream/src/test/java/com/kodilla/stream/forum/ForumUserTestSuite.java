...
public class ForumUserTestSuite {
    @Test
    public void testGetLocationsOffFriends(){
        //Given
        //Create users
        ...
        //   user7:  "Washington"
        //   user10: "Miami"
        Assert.assertEquals(3, user1.getLocationsOffFriends().size());
        Assert.assertTrue(user1.getLocationsOffFriends().contains("Key West"));
        Assert.assertTrue(user1.getLocationsOffFriends().contains("Washington"));
        Assert.assertTrue(user1.getLocationsOffFriends().contains("Miami"));
        Assert.assertFalse(user1.getLocationsOffFriends().contains("Orlando"));
    }
    @Test
